...
- **R1 recap page**: `r1-recap.html` — standalone static page with leaderboard, series results, key insights, and full pick grid for Round 1. Accessible at `galfogel.github.io/NBA-Bracket/r1-recap.html`. No app.js dependency; all data is hardcoded HTML. Nav is a single "← App" link top-right; no section links.
